    ...
    <div className="min-h-screen bg-brand-canvas py-20 px-4">
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-soft border border-brand-line p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-brand-ink mb-1">Business Name</label>
            <input
              type="text"
              required
              value={businessName}
          ...
          <div>
            <label className="block text-sm font-medium text-brand-ink mb-1">Confirm Password</label>
            <input
              type="password"
              required
